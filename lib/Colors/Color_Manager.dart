...
class Color_Manager extends InheritedWidget {
  ...
  static Color_Manager of(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<Color_Manager>() ?? Color_Manager(child: Placeholder(), primary_color: Colors.blue, secondary_color: Colors.blue, background_color : Colors.blue, text_color : Colors.blue, active_color : Colors.blue, inactive_color : Colors.blue, active_size_color : Colors.blue, active_confirm_color : Colors.blue, active_deny_color : Colors.blue,  color_blind_option_1: (){}, reset_colors: (){},);
}